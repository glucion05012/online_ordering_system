...
<table id="myTable" class="table table-striped table-bordered table-sm" cellspacing="0" width="100%">
    ...
    <tbody>           
            <?php foreach($orders as $or) : ?>
                <?php if($or['order_status'] == "COMPLETED") : ?>
                    <?php if($_SESSION['user_type'] == "admin") : ?>
                        <tr class="table-active"> 
                            ...
                            <td>
                                <?php
                                    $ord = new DateTime($or['datetime_ordered']);
                                    $del = new DateTime($or['datetime_delivered']);

                                    echo "<span>COMPLETED <br> Time Waited: ". $ord->diff($del)->format("%h h and %i m").'</span>';
                                ?>
                            </td>
                            ...
                            <tr class="table-active"> 
                                ...
                                <td>
                                    <?php
                                        ...
                                        echo "<span style='background-color:lightgreen'>COMPLETED <br> Time Waited: ". $ord->diff($del)->format("%h h and %i m").'</span>';
                                    ?>
                                </td>
                                <td><?php echo $or['room_no']; ?></td>
                                <td>
